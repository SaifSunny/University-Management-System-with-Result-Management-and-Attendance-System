...
if (isset($_POST['submit'])) {
    ...
    $query = "SELECT * FROM department WHERE `dep_name` = '$dep_name'";
    $query_run = mysqli_query($conn, $query);

    if (!$query_run->num_rows > 0) {
        $query2 = "INSERT INTO department(dep_name, dep_code)
        ...
        if ($query_run2) {
            ...
            echo "<script>alert('Cannot save Department')</script>";
                            ...
                            <div class="col-md-8">
                                <div class="card mx-auto" style="padding:50px 20px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); ">
                                    <div class="card-title">
                                        <h2 style="padding-left:10px; font-weight:1000">Add Department</h2>
                                    </div>
                                            ...
                                            <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group" style="padding:10px">
                                                            ...
                                                            <input type="text" class="form-control" name="dep_name" id="dep_name" placeholder="Department Name" required>
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group" style="padding:10px">
                                                            ...
                                                            <input type="text" class="form-control" name="dep_code" id="dep_code" placeholder="Department Code" required>
                                                        </div>
                                                    </div>
                                            </div>

                                            <div class="d-flex justify-content-end" style="padding-top:10px;">
                                                <button type="submit" name="submit" class="btn btn-success" style="margin-right:10px;">Add Department</button>
