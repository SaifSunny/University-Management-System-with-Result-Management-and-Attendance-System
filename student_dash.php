...
$_SESSION['username']=$row['firstname'].' '.$row['lastname'].' ('.$_SESSION['student_id'].')';
        ...
        <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse" style="background:#1690A7; margin-top:20px">
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                    <a href="student_dash.php" class="list-group-item list-group-item-action py-2 bg-primary active"
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="" style="text-align:center;padding:30px 0px;">
                                <h3 class="card-title" style="padding-bottom:20px;">Welcome <?php echo $_SESSION['username']?></h3>
                                ...
                                <div class="row" style="padding:20px">
                                        <div class="card mx-auto col-md-4"
                                            ...
                                            <?php
                                                $sql = "SELECT DISTINCT course_code from student_course WHERE student_id='$student_id'";
                                                $result = mysqli_query($conn, $sql);
                                        ...
                                        <div class="card mx-auto col-md-4"
                                            ...
                                            <?php
                                                $sql = "SELECT DISTINCT class_id from student_result WHERE student_id='$student_id'";
                                                $result = mysqli_query($conn, $sql);
                                                $row_cnt = $result->num_rows;
                                            ?>
                                            <h1><?php echo $row_cnt?></h1>
