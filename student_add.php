...
if (isset($_POST['submit'])) {
    ...
    if (!$query_run->num_rows > 0) {
            ...
            $query2 = "INSERT INTO student(student_id, firstname, lastname, gender, birthday, email, contact, 
            `address`, city, zip, username,`password`,dep_id, dep_code, prog_id, prog_name, reg_sem_id, reg_sem)
            VALUES ('$student_id','$firstname','$lastname','$gender','$birthday','$email','$contact','$address',
            '$city','$zip','$username', '$password','$dep_id',(SELECT dep_code FROM department WHERE dep_id='$dep_id'), 
            '$prog_id', (SELECT prog_name FROM program WHERE prog_id='$prog_id'), '$reg_sem_id', 
            (SELECT sem_code FROM semester WHERE sem_id='$reg_sem_id'))";
            $query_run2 = mysqli_query($conn, $query2);

            if ($query_run2) {
                echo "<script> alert('Student Successfully ADDED.');
                window.location.href='student.php';
                </script>";
                
            } else {
                echo "<script>alert('Cannot save Student')</script>";
            }
                        ...
                        <div class="col-md-8">
                            <div class="card mx-auto"
                                ...
                                <div class="card-title">
                                    <h2 style="padding-left:10px; font-weight:1000">Add Student</h2>
                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="text" class="form-control" name="student_id"
                                                            id="student_id" placeholder="Student ID" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
