...
if (isset($_POST['submit'])) {
    ...
    $dep_code = $_POST['dep_code'];
      ...
      $query2 = "UPDATE department SET dep_name='$dep_name', dep_code='$dep_code' WHERE dep_id='$dep_id'";
      $query_run2 = mysqli_query($conn, $query2);
      if ($query_run2) {
        echo "<script> alert('Department has been UPDATED.');
        window.location.href='department.php';</script>";
      } else {
        echo "<script>alert('Cannot Update Department')</script>";
      }
  }
        ...
        <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse" style="background:#1690A7; margin-top:20px">
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                    ...
                    <a href="department.php" class="list-group-item list-group-item-action py-2 bg-primary active"
                            ...
                            <div class="col-md-8">
                                <div class="card mx-auto" style="padding:50px 20px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); ">
                                    <div class="card-title">
                                        <h2 style="padding-left:10px; font-weight:1000">Update Department</h2>
                                    </div>
                                    ...
                                    <div class="card-body" id="card-body">
                                        ...
                                        <form action="" method="POST">
                                            <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group" style="padding:10px">
                                                            ...
                                                            <input type="text" class="form-control" name="dep_name" id="dep_name" placeholder="Department Name" value="<?php echo $dep_name ?>" required>
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group" style="padding:10px">
                                                            ...
                                                            <input type="text" class="form-control" name="dep_code" id="dep_code" placeholder="Department Code" value="<?php echo $dep_code ?>" required>
                                                        </div>
                                                    </div>
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-end" style="padding-top:10px;">
                                                ...
                                                <a href="department.php" class="btn btn-primary">Go Back</a>
                                            </div>
                                        </form>
