...
if (isset($_POST['submit'])) {
    ...
    $sem_code = $_POST['sem_code'];
      ...
      $query2 = "UPDATE semester SET sem_name='$sem_name', sem_year='$sem_year', sem_code='$sem_code' WHERE sem_id='$sem_id'";
      $query_run2 = mysqli_query($conn, $query2);
      if ($query_run2) {
        echo "<script> alert('Semester has been UPDATED.');
        window.location.href='semester.php';</script>";
      } else {
        echo "<script>alert('Cannot Update Semester')</script>";
      }
  }
        ...
        <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse" style="background:#1690A7; margin-top:20px">
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                    ...
                    <a href="semester.php" class="list-group-item list-group-item-action py-2 bg-primary active"
                        style="background:#1690A7; Color:white;">
                            ...
                            <div class="col-md-8">
                                <div class="card mx-auto" style="padding:50px 20px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); ">
                                    <div class="card-title">
                                        <h2 style="padding-left:10px; font-weight:1000">Update Semester</h2>
                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group" style="padding:10px">
                                                            ...
                                                            <select class="form-control" name="sem_name" id="sem_name" required>
                                                                <option value="<?php echo $sem_name?>"><?php echo $sem_name?></option>
                                            ...
                                            <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group" style="padding:10px">
                                                            ...
                                                            <input type="number" class="form-control" name="sem_year" id="sem_year" min="2020" max="2099" value="<?php echo $sem_year?>" placeholder="Year" required>
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group" style="padding:10px">
                                                            ...
                                                            <input type="text" class="form-control" name="sem_code" id="sem_code" placeholder="Semester Code" value="<?php echo $sem_code?>"  required>
                                                        </div>
                                                    </div>
                                            </div>

                                            <div class="d-flex justify-content-end" style="padding-top:10px;">
                                                <button type="submit" name="submit" class="btn btn-success" style="margin-right:10px;">Update</button>
                                                <a href="semester.php" class="btn btn-primary">Go Back</a>
                                            </div>
                                        </form>
