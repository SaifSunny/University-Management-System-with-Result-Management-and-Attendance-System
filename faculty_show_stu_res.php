                        ...
                        <div class="col-md-12">
                            <div class="card mx-auto"
                                ...
                                <div class="card-title">
                                    <h2 style="padding-left:10px; font-weight:1000">Publish Result</h2>
                                </div>
                                ...
                                <div class="card-body" id="card-body">
                                    <form action="" method="POST">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php 
                                            $sql = "SELECT * FROM student_result WHERE class_id='$class_id'";
                                            ...
                                            if($result){
                                                ...
                                                while($row=mysqli_fetch_assoc($result)){
                                                    ...
                                                    $grade = $row['grade'];
                                                        ...
                                                        <td>'.$grade.'</td>
                                                        <td>
                                                            <a href="faculty_result_update.php?class_id='.$class_id.'&student_id='.$student_id.'" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                                        </td>
