...
if (isset($_POST['submit'])) {
    ...
    $reg_sem_id=$_POST['select_sem'];


    $query = "SELECT * FROM student WHERE student_id = '$student_id'";
    $query_run = mysqli_query($conn, $query);

            $query2 = "UPDATE student SET firstname = '$firstname',lastname = '$lastname',
            gender = '$gender', birthday ='$birthday', email = '$email', contact='$contact',`address`='$address',
            city = '$city', zip = '$zip',dep_id='$dep_id', dep_code = (SELECT dep_code FROM department WHERE dep_id='$dep_id'),
            prog_id = '$prog_id', prog_name=(SELECT prog_name FROM program WHERE prog_id='$prog_id'),
            reg_sem_id = '$reg_sem_id', reg_sem=(SELECT sem_code FROM semester WHERE sem_id='$reg_sem_id') WHERE student_id='$student_id'";

            $query_run2 = mysqli_query($conn, $query2);

            if ($query_run2) {
                echo "<script> alert('Student Successfully Updated.');
                window.location.href='student.php';
                </script>";
                
            } else {
                echo "<script>alert('Cannot Update Student')</script>";
            }
}
                        ...
                        <div class="col-md-8">
                            <div class="card mx-auto"
                                ...
                                <div class="card-title">
                                    <h2 style="padding-left:10px; font-weight:1000">Update Student Details</h2>
                                </div>
                                ...
                                <div class="card-body" id="card-body">
                                    <div class="container">
                                        ...
                                        <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <select class="form-control" id="select_dep" name="select_dep"
                                                            required>
                                                            <option value ="<?php echo $dep_id?>"><?php echo $dep_code?></option>
                                                            <?php
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        <label style="padding-bottom:10px;">Registered Semester</label>
                                                        <select class="form-control" id="select_sem" name="select_sem"
                                                            required>
                                                            <option value ="<?php echo $reg_sem_id?>"><?php echo $reg_sem?></option>
                                                            <?php
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="text" class="form-control" name="firstname"
                                                            id="firstname" placeholder="First Name" value ="<?php echo $firstname?>" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="text" class="form-control" name="lastname"
                                                            id="lastname" placeholder="Last Name" value ="<?php echo $lastname?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <select class="form-control" name="gender" id="gender"
                                                            ...
                                                            <option value ="<?php echo $student_id?>"><?php echo $gender?></option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="date" class="form-control" name="birthday"
                                                            id="birthday" placeholder="Birthday" value ="<?php echo $birthday?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="text" class="form-control" name="contact"
                                                            id="contact" placeholder="Contact" value ="<?php echo $contact?>" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="text" class="form-control" name="address"
                                                            id="address" placeholder="Address" value ="<?php echo $address?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
