                            ...
                            <div class="col-md-12">
                                <div class="card mx-auto" style="text-align:center;padding:50px 20px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); ">
                                    <div class="card-title">
                                        <h2 style="padding-left:10px; font-weight:1000">Manage Department</h2>
                                    </div>
                                    <div class="d-flex justify-content-end" style="padding-right:20px;">
                                    <a href="department_add.php" class="btn btn-primary"><i class="fa fa-plus"></i> Add Department</a>
                                    </div>
                                        ...
                                        <table class="table">
                                            ...
                                            if($result){
                                                while($row=mysqli_fetch_assoc($result)){
                                                    ...
                                                    <td>'.$dep_code.'</td>
                                                    <td>
                                                    <a href="department_update.php?dep_id='.$dep_id.'" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                                    <a href="department_delete.php?dep_id='.$dep_id.'" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                    </tr>';
                                                }
                                            }
