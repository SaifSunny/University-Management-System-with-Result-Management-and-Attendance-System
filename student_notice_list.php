                        ...
                        <div class="col-md-12">
                            <div class="card mx-auto"
                                ...
                                <div class="card-title">
                                    <h2 style="padding-left:10px; font-weight:1000">All Notice</h2>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            if($result){
                                                ...
                                                while($row=mysqli_fetch_assoc($result)){
                                                    ...
                                                    <td>'.$notice_from.'</td>
                                                    <td>'.$notice_to.'</td>
                                                    <td><a href="student_notice_view.php?notice_id='.$notice_id.'" style="text-decoration: none;font-weight: 600;">'.$subject.'</a></td>
                                                    </tr>';
                                                    $i++;
                                                }
                                            }
