...
if (isset($_POST['submit'])) {
    ...
    $prog_id = $_POST['select_prog'];
      ...
      $query2 = "UPDATE course SET course_name='$course_name', course_code='$course_code', credit='$credit', dep_id='$dep_id', dep_code= (SELECT dep_code FROM department WHERE dep_id='$dep_id'), 
      prog_id='$prog_id', prog_name=(SELECT prog_name FROM program WHERE prog_id='$prog_id') WHERE course_id='$course_id'";
      $query_run2 = mysqli_query($conn, $query2);
      if ($query_run2) {
        echo "<script> alert('Course has been UPDATED.');
        window.location.href='course.php';</script>";
      } else {
        echo "<script>alert('Cannot Update Course');
        window.location.href='course.php';</script>
        </script>";
      }
  }
                        ...
                        <div class="col-md-8">
                            <div class="card mx-auto"
                                ...
                                <div class="card-title">
                                    <h2 style="padding-left:10px; font-weight:1000">Update Course</h2>
                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="text" class="form-control" name="course_code"
                                                            id="course_code" placeholder="Course Code"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="text" class="form-control" name="credit"
                                                            id="credit" placeholder="Credit Hour"
                                                            value="<?php echo $credit?>" required>
                                                    </div>
                                                </div>
                                            </div>
