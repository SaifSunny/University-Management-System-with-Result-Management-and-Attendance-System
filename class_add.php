...
if (isset($_POST['submit'])) {
    ...
    $query = "SELECT * FROM class WHERE course_name = (SELECT course_name FROM course WHERE course_id='$course_id') AND course_code = (SELECT course_code FROM course WHERE course_id='$course_id') AND section='$section' AND sem_id='$sem_id'";
    $query_run = mysqli_query($conn, $query);

    if (!$query_run->num_rows > 0) {
        $query = "SELECT * FROM class WHERE faculty_id = '$faculty_id' AND schedule='$schedule' AND sem_id='$sem_id'";
        $query_run = mysqli_query($conn, $query);
        if (!$query_run->num_rows > 0) {
            $query = "SELECT * FROM class WHERE course_id = '$course_id' AND room='$room' AND schedule='$schedule' AND sem_id='$sem_id'";
            $query_run = mysqli_query($conn, $query);
            if(!$query_run->num_rows > 0) {
                $query2 = "INSERT INTO class(course_id, course_name, course_code, credit, prog_id, prog_name, dep_id, dep_code, section, room,
                schedule, capacity, faculty_id, faculty_name, sem_id, sem_code) VALUES ('$course_id',(SELECT course_name FROM course WHERE course_id='$course_id'),(SELECT course_code FROM course WHERE course_id='$course_id'),
                (SELECT credit FROM course WHERE course_id='$course_id'),'$prog_id',(SELECT prog_name FROM program WHERE prog_id='$prog_id'),'$dep_id',(SELECT dep_code FROM department WHERE dep_id='$dep_id'),
                '$section','$room', '$schedule', '$capacity', '$faculty_id', (SELECT CONCAT(firstname, lastname) FROM faculty WHERE faculty_id='$faculty_id'), 
                '$sem_id',(SELECT sem_code FROM semester WHERE sem_id='$sem_id'))";
                $query_run2 = mysqli_query($conn, $query2);
                if ($query_run2) {
                    echo "<script> alert('Class Successfully Scheduled.');
                    window.location.href='class.php';
                    </script>";
                    
                } else {
                    echo "<script>alert('Cannot Schedule Class')</script>";
                }
            }
            else{
            echo "<script>alert('Classroom Not Avalable at the Schedule')</script>";
            }
        }
        else{
        ...
        echo "<script>alert('Class is Already Scheduled')</script>";
                        ...
                        <div class="col-md-8">
                            <div class="card mx-auto"
                                ...
                                <div class="card-title">
                                    <h2 style="padding-left:10px; font-weight:1000">Add Class</h2>
                                </div>
                                        ...
                                        <form action="" method="POST">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <select class="form-control" id="select_prog" name="select_prog"
                                                            required>
                                                            ...
                                                            <option value="<?php echo $row2['prog_id']; ?>">
                                                                <?php echo $row2['prog_name']; ?> </option>
                                                            <?php
                                                                }
                                                            }
                                                            ?>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <select class="form-control" id="select_course"
                                                            name="select_course" required>
                                                            <option>-- Select Course --</option>
                                                            <?php
                                                            $br_option = "SELECT * FROM course";
                                                            $br_option_run = mysqli_query($conn, $br_option);
                                                            ...
                                                            <option value="<?php echo $row2['course_id']; ?>">
                                                                ...
                                                                (<?php echo $row2['course_code'];?>)</option>
                                                            <?php
                                                                }
                                                            }
                                                            ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="text" class="form-control" name="capacity"
                                                            id="capacity" placeholder="Section Capacity" required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="text" class="form-control" name="section"
                                                            id="section" placeholder="Section" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                            ...
                                            <div class="d-flex justify-content-end" style="padding-top:10px;">
                                                <button type="submit" name="submit" class="btn btn-success"
                                                    style="margin-right:10px;">Schedule Class</button>
                                                <a href="class.php" class="btn btn-primary">Go Back</a>
                                            </div>
                                        </form>
