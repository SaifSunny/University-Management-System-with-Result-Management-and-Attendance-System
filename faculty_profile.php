                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px;">
                                                        <label style="padding-bottom:10px;font-weight:700;">NID Number</label><br>
                                                        <?php echo $nid?>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px;">
                                                        <label style="padding-bottom:10px;font-weight:700;">Education</label><br>
                                                        <?php echo $education?>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        <label style="padding-bottom:10px; font-weight:700;">Joined Semester</label><br>
                                                        <?php echo $join_sem?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-end" style="padding-top:10px;">
                                            <a href="faculty_profile_update.php" class="btn btn-success" style="margin-right:10px;">Edit Profile</a>
