                                        ...
                                        <tbody>
                                            ...
                                            if($result){
                                                ...
                                                while($row=mysqli_fetch_assoc($result)){
                                                    ...
                                                    <td>'.$room.'</td>
                                                    <td>'.$schedule.'</td>
                                                    <td><a href="faculty_set_result.php?class_id='.$class_id.'" class="btn btn-success">Publish Result</a>                                                    
                                                    <a href="faculty_show_stu_res.php?class_id='.$class_id.'" class="btn btn-primary">Class Result</a>                                                    
                                                    </tr>';
                                                    $i++;
                                                }
                                            }
