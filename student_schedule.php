        ...
        <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse" style="background:#1690A7; margin-top:20px">
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                    ...
                    <a href="student_schedule.php" class="list-group-item list-group-item-action py-2 bg-primary active"
                            ...
                            <div class="card mx-auto"
                                ...
                                <div class="card-body" id="card-body">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php 
                                            $sql = "SELECT * from student_course WHERE student_id='$student_id' AND sem_id= (SELECT sem_id FROM semester ORDER BY sem_id DESC LIMIT 1)";
