                            ...
                            <div class="col-md-12">
                                <div class="card mx-auto" style="text-align:center;padding:50px 20px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); ">
                                    <div class="card-title">
                                        <h2 style="padding-left:10px; font-weight:1000">Manage Semester</h2>
                                    </div>
                                    <div class="d-flex justify-content-end" style="padding-right:20px;">
                                    <a href="semester_add.php" class="btn btn-primary"><i class="fa fa-plus"></i> Add Semester</a>
                                    </div>
                                        ...
                                        <table class="table">
                                            ...
                                            if($result){
                                                while($row=mysqli_fetch_assoc($result)){
                                                    ...
                                                    <td>'.$sem_code.'</td>
                                                    <td>
                                                    <a href="semester_update.php?sem_id='.$sem_id.'" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                                    <a href="semester_delete.php?sem_id='.$sem_id.'" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                    </tr>';
                                                }
                                            }
