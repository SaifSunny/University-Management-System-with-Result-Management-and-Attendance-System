...
if (isset($_POST['submit'])) {
    ...
    if (!$query_run->num_rows > 0) {
        $query2 = "INSERT INTO program(prog_name, dep_id, dep_code)
        VALUES ('$prog_name','$dep_id',(SELECT dep_code FROM department WHERE dep_id='$dep_id'))";
        $query_run2 = mysqli_query($conn, $query2);
        if ($query_run2) {
            echo "<script> alert('Program Successfully ADDED.');
            window.location.href='program.php';
            </script>";
            
        } else {
            echo "<script>alert('Cannot save Program')</script>";
            
        }
    } else {
        echo "<script>alert('Program Already Exists')</script>";
                            ...
                            <div class="col-md-8">
                                <div class="card mx-auto" style="padding:50px 20px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); ">
                                    <div class="card-title">
                                        <h2 style="padding-left:10px; font-weight:1000">Add Program</h2>
                                    </div>
                                    ...
                                    <div class="card-body" id="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="d-flex justify-content-end" style="padding-top:10px;">
                                                <button type="submit" name="submit" class="btn btn-success" style="margin-right:10px;">Add Program</button>
