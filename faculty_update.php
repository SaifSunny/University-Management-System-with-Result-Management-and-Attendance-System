...
if (isset($_POST['submit'])) {
    ...
    $sem_id=$_POST['select_sem'];
      ...
      join_sem=(SELECT sem_code FROM semester WHERE sem_id='$sem_id') WHERE faculty_id='$faculty_id'";
      
      $query_run2 = mysqli_query($conn, $query2);
      if ($query_run2) {
        echo "<script> alert('Faculty has been UPDATED.');
                        ...
                        <div class="col-md-8">
                            <div class="card mx-auto"
                                ...
                                <div class="card-title">
                                    <h2 style="padding-left:10px; font-weight:1000">Update Faculty</h2>
                                </div>
