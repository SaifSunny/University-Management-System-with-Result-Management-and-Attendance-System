                        ...
                        <div class="col-md-8">
                            <div class="card mx-auto"
                                ...
                                <div class="card-title">
                                    <h2 style="padding-left:10px; font-weight:1000">Student Profile</h2>
                                </div>
                                ...
                                <div class="card-body" id="card-body">
                                    <div class="container">
                                        <form action="" method="POST">
                                            <div class="row">
                                                <img class="card-img-top mx-auto" style="width:40%;padding-bottom:20px;" src="./images/user-profile.png" alt="Profile Image">
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        <label style="padding-bottom:10px;">Department</label>
                                                        <input type="text" class="form-control" value ="<?php echo $dep_code?>" readonly>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="text" class="form-control"  value ="<?php echo $reg_sem?>" readonly>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value ="<?php echo $prog_name?>" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="text" class="form-control" name="firstname"
                                                            id="firstname" placeholder="First Name" value ="<?php echo $firstname?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="text" class="form-control" name="lastname"
                                                            id="lastname" placeholder="Last Name" value ="<?php echo $lastname?>" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <select class="form-control" name="gender" id="gender" placeholder="Gender" readonly>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="date" class="form-control" name="birthday"
                                                            id="birthday" placeholder="Birthday" value ="<?php echo $birthday?>" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="text" class="form-control" name="contact"
                                                            id="contact" placeholder="Contact" value ="<?php echo $contact?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="text" class="form-control" name="address"
                                                            id="address" placeholder="Address" value ="<?php echo $address?>" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group" style="padding:10px">
                                                        ...
                                                        <input type="text" class="form-control" name="zip" id="zip"
                                                            placeholder="Zip" value ="<?php echo $zip?>" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-end" style="padding-top:10px;">
                                                <a href="student_update.php?student_id=<?php echo $student_id?>" style="margin-right:10px;" class="btn btn-success">Update Profile</a>
