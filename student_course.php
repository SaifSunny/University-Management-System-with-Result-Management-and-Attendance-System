        ...
        <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse" style="background:#1690A7; margin-top:20px">
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                    ...
                    <a href="student_course.php" class="list-group-item list-group-item-action py-2 bg-primary active"
                        ...
                        <div class="col-md-12">
                            <div class="card mx-auto"
                                ...
                                <div class="card-title">
                                    <h2 style="padding-left:10px; font-weight:1000">My Courses</h2>
                                </div>
                                ...
                                <div class="card-body" id="card-body">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php 
                                            $sql = "SELECT DISTINCT course_name,course_code,credit,prog_name,dep_code from student_course WHERE student_id='$student_id' AND sem_id= (SELECT sem_id FROM semester ORDER BY sem_id DESC LIMIT 1)";
