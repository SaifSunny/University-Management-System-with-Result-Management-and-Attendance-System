                                    ...
                                    <div class="card-body" id="card-body">
                                        ...
                                        <form action="" method="POST">
                                            <div class="row">
                                                ...
                                                <img src="./images/user-profile.png" style="width:35%;" alt="profile">
                                                </div>
                                            </div>
                                            <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group" style="padding:10px">
                                                            ...
                                                            <input type="text" class="form-control" name="firstname" id="firstname" value="<?php echo $firstname?>" placeholder="First Name" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group" style="padding:10px">
                                                            <label style="padding-bottom:10px;">Last Name</label>
                                                            <input type="text" class="form-control" name="lastname" id="lastname" value="<?php echo $lastname?>" placeholder="Last Name" readonly>
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group" style="padding:10px">
                                                            ...
                                                            <input type="text" class="form-control" name="gender" id="gender" value="<?php echo $gender?>" placeholder="Gender" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group" style="padding:10px">
                                                            <label style="padding-bottom:10px;">Birthday</label>
                                                            <input type="text" class="form-control" name="birthday" id="birthday" value="<?php echo $birthday?>" placeholder="Birthday" readonly>
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group" style="padding:10px">
                                                            ...
                                                            <input type="text" class="form-control" name="email" id="email" value="<?php echo $email?>" placeholder="Email Address" readonly>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group" style="padding:10px">
                                                            ...
                                                            <input type="text" class="form-control" name="contact" id="contact" value="<?php echo $contact?>" placeholder="Contact" readonly>
                                            ...
                                            <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group" style="padding:10px">
                                                            ...
                                                            <input type="text" class="form-control" name="address" id="address" value="<?php echo $address?>" placeholder="Address" readonly>
                                            ...
                                            <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group" style="padding:10px">
                                                            ...
                                                            <input type="text" class="form-control" name="city" id="city" value="<?php echo $city?>" placeholder="City" readonly>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group" style="padding:10px">
                                                            ...
                                                            <input type="text" class="form-control" name="zip" id="zip" value="<?php echo $zip?>" placeholder="Zip" readonly>

                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="d-flex justify-content-end" style="padding-top:10px;">
                                                <a href="admin_update.php" class="btn btn-success" style="margin-right:10px;">Edit Profile</a>
                                                <a href="admin_dash.php" class="btn btn-primary">Go Back</a>
                                            </div>
                                        </form>
