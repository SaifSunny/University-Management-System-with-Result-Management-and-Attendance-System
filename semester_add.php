...
if (isset($_POST['submit'])) {
    ...
    if (!$query_run->num_rows > 0) {
        ...
        if (!$query_run->num_rows > 0) {
            ...
            if ($query_run2) {
                echo "<script> alert('Semester Successfully ADDED.');
                window.location.href='semester.php';
                </script>";
                
            } else {
                echo "<script>alert('Cannot save Semester')</script>";
                
            }
        }
        else{
            echo "<script>alert('Semester Code Already Exists')</script>";
        }
                            ...
                            <div class="col-md-8">
                                <div class="card mx-auto" style="padding:50px 20px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); ">
                                    <div class="card-title">
                                        <h2 style="padding-left:10px; font-weight:1000">Add Semester</h2>
                                    </div>
                                            ...
                                            <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group" style="padding:10px">
                                                            ...
                                                            <input type="number" class="form-control" name="sem_year" id="sem_year" min="2020" max="2099" value="<?php echo date('Y');?>" placeholder="Year" required>
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group" style="padding:10px">
                                                            ...
                                                            <input type="text" class="form-control" name="sem_code" id="sem_code" placeholder="Semester Code" required>
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="d-flex justify-content-end" style="padding-top:10px;">
                                                <button type="submit" name="submit" class="btn btn-success" style="margin-right:10px;">Add Semester</button>
