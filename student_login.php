...
if (isset($_POST['submit'])) {
	...
	if ($result->num_rows > 0) {
        ...
        $_SESSION['role'] = $row['role'];
			...
			$sql = "INSERT INTO recent(`name`, `role`) VALUES ('$student_id', 'Student')";
			$result = mysqli_query($conn, $sql);
			if($result){
				header("Location: student_dash.php");
			}
...
<body>
	...
	<form action="" method="POST" class="login-email">
		...
		<div class="form-group">
			...
			<input type="text" placeholder="Enter Student ID" name="student_id" required><br>
		</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9 bg-light text-right">
                    <a href="student_signup.php" class="ca ">Forgot Password? ?</a>
                </div>
