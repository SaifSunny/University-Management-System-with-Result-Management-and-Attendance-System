...
if (isset($_POST['submit'])) {
    ...
    if (!$query_run->num_rows > 0) {
        ...
        $query_run = mysqli_query($conn, $query);
        if (!$query_run->num_rows > 0) {
            $query2 = "INSERT INTO course(course_name, course_code, credit, dep_id, dep_code, prog_id, prog_name)
            VALUES ('$course_name','$course_code','$credit', '$dep_id', (SELECT dep_code FROM department WHERE dep_id='$dep_id'),
            '$prog_id',(SELECT prog_name FROM program WHERE prog_id='$prog_id'))";
            $query_run2 = mysqli_query($conn, $query2);
            if ($query_run2) {
                echo "<script> alert('Course Successfully ADDED.');
                window.location.href='course.php';
                </script>";
                
            } else {
                echo "<script>alert('Cannot save Course')</script>";
        ...
        <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse" style="background:#1690A7; margin-top:20px">
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                    ...
                    <a href="course.php" class="list-group-item list-group-item-action py-2 bg-primary active "
                            ...
                            <div class="col-md-8">
                                <div class="card mx-auto" style="padding:50px 20px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); ">
                                    <div class="card-title">
                                        <h2 style="padding-left:10px; font-weight:1000">Add Course</h2>
                                    </div>
                                        ...
                                        <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group" style="padding:10px">
                                                            ...
                                                            ?>
                                                                    <option value="<?php echo $row2['dep_id']; ?>"> <?php echo $row2['dep_code']; ?> </option>
                                                            <?php
                                                                }
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group" style="padding:10px">
                                                            ...
                                                            if (mysqli_num_rows($br_option_run) > 0) {
                                                                foreach ($br_option_run as $row2) {
                                                            ?>
                                                                    <option value="<?php echo $row2['prog_id']; ?>"> <?php echo $row2['prog_name']; ?> </option>
                                                            <?php
                                                                }
                                                            }
                                                            ?>
                                            ...
                                            <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group" style="padding:10px">
                                                            <label style="padding-bottom:10px;">Credit</label>
                                                            <input type="text" class="form-control" name="credit" id="credit" placeholder="Credit Hour" required>
                                                        </div>
                                                    </div>
                                            </div>

                                            <div class="d-flex justify-content-end" style="padding-top:10px;">
                                                <button type="submit" name="submit" class="btn btn-success" style="margin-right:10px;">Add Course</button>
