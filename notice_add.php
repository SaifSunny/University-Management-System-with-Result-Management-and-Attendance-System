...
if (isset($_POST['submit'])) {
    ...
    $query = "SELECT * FROM notice WHERE `subject` = '$subject' AND `message` = '$message'";
    $query_run = mysqli_query($conn, $query);

    if (!$query_run->num_rows > 0) {
        $query2 = "INSERT INTO notice(notice_date, notice_from,notice_to,`subject`,`message`)
        VALUES ('$notice_date','$notice_from','$notice_to','$subject','$message')";
        $query_run2 = mysqli_query($conn, $query2);
        if ($query_run2) {
            echo "<script> alert('Notice Successfully ADDED.');
            window.location.href='notice.php';
            </script>";
            
        } else {
            echo "<script>alert('Cannot save Notice')</script>";
        ...
        <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse" style="background:#1690A7; margin-top:20px">
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                    ...
                    <a href="notice.php" class="list-group-item list-group-item-action py-2 bg-primary active"
                        style="background:#1690A7; Color:white;"><i
                            ...
                            <div class="col-md-8">
                                <div class="card mx-auto" style="padding:50px 20px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); ">
                                    <div class="card-title">
                                        <h2 style="padding-left:10px; font-weight:1000">Add Notice</h2>
                                    </div>
                                    ...
                                    <div class="card-body" id="card-body">
                                        ...
                                        <form action="" method="POST">
                                            <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group" style="padding:10px">
                                                            <label style="padding-bottom:10px;">Notice From</label>
                                                            <input type="text" class="form-control" name="notice_from" id="notice_from" placeholder="Notice From" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group" style="padding:10px">
                                                            <label style="padding-bottom:10px;">Notice TO</label>
                                            ...
                                            <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group" style="padding:10px">
                                                            <label style="padding-bottom:10px;">Subject</label>
                                            ...
                                            <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group" style="padding:10px">
                                                            <label style="padding-bottom:10px;">Message</label>
                                                            <textarea class="form-control" name="message" id="message" rows="8" placeholder="Message" required></textarea>
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="d-flex justify-content-end" style="padding-top:10px;">
                                                <button type="submit" name="submit" class="btn btn-success" style="margin-right:10px;">Add Notice</button>
                                                <a href="notice.php"  class="btn btn-primary">Go Back</a>
                                            </div>
                                        </form>
