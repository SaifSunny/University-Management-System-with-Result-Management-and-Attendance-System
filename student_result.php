                        ...
                        <div class="col-md-12">
                            <div class="card mx-auto"
                                ...
                                <div class="card-title">
                                    <h2 style="padding-left:10px; font-weight:1000">Grade Sheet</h2>
                                </div>
                                ...
                                <div class="card-body" id="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            if($result){
                                                ...
                                                while($row=mysqli_fetch_assoc($result)){
                                                    ...
                                                    <td><a href="student_show_marks.php?class_id='.$class_id.'" class="btn btn-success">Show Marks</a></td>
                                                    </tr>';
                                    ...
                                    <div class="d-flex justify-content-end"
                                        style="padding-top:10px; padding-right:255px;">
                                        <strong>CGPA : <?php echo $cgpa ?></strong>
                                    </div>
