                                ...
                                <div class="card-body" id="card-body">
                                    <form action="" method="POST">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php 
                                            $sql = "SELECT DISTINCT att_date, course_name, course_code, section FROM student_att WHERE class_id='$class_id'";
                                            ...
                                            if($result){
                                                ...
                                                while($row=mysqli_fetch_assoc($result)){
                                                    ...
                                                    <td>'.$course_code.'</td>
                                                    <td>'.$section.'</td>
                                                    <td><a href="faculty_show_stu_att.php?class_id='.$class_id.'&att_date='.$att_date.'" class="btn btn-success">Show Attendence</a></td>
                                                    </tr>';
                                                    $i++;
                                                }
                                            }
