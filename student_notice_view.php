        ...
        <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse" style="background:#1690A7; margin-top:20px">
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                    ...
                    <a href="student_notice_list.php" class="list-group-item list-group-item-action py-2  bg-primary active"
                        style="background:#1690A7; Color:white;">
                                    ...
                                    <div class="container">
                                        <form action="" method="POST">
                                            ...
                                            <div class="d-flex justify-content-end" style="padding-top:10px;">
                                                <a href="student_notice_list.php" class="btn btn-primary">Go Back</a>
                                            </div>
                                        </form>
                        ...
                        <div class="col-md-4">
                            <div class="card"
                                ...
                                <table class="table">
                                    ...
                                    if($result){
                                        while($row=mysqli_fetch_assoc($result)){
                                            ...
                                            <td style="font-size:14px; font-weight:600;text-align:justify; "><a href="student_notice_view.php?notice_id='.$notice_id.'" style="text-decoration:none; "> <span style="padding-left:20px;">'.$subject.'</span><a></td>
                                            </tr>';
                                        }
                                    }
                                    ?> 
                                ...
                                <div style="text-align:center;">
                                    <a href="student_notice_list.php" style="text-decoration:none;"> <span style="padding-left:20px;font-weight:500;">See All</span><a>
                                </div>
                                </div>
